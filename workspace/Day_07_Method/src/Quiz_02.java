...
//		int count2 = countTarget(str, "Ivaj");
//		System.out.println("Ivaj의 개수 : " + count2);
//		int count3 = countTarget(str, "Jiva");
//		System.out.println("Jiva의 개수 : " + count3);
//		int count4 = countTarget(str, "Iava");
//		System.out.println("Iava의 개수 : " + count4);
//		int count5 = countTarget(str, "Jvaa");
//		System.out.println("Jvaa의 개수 : " + count5);
	}
	static int countJava(String str) {
		String[] sArr = str.split(":");
		int cnt = 0;
		for(int i = 0; i < sArr.length; i++) {
			if(sArr[i].contains("Java")) {
				cnt++;
			}
		}
		return cnt;
