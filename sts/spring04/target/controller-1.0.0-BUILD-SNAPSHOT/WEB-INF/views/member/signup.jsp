...
<head>
    ...
    <script src="${pageContext.request.contextPath}/rersources/webjars/jquery/3.6.4/jquery.js"></script>
    <style>
        * {
            padding: 0px;
        }
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-center">
                ...
                <a href="/">
                	<button class="btn btn-outline-danger m-1" type="button">뒤로가기</button>
                </a>
            </div>
        </div>
    </div>
