package kh.demo.springboard.config;
...
@Configuration
@ComponentScan(basePackages = "kh.demo.springboard")
@PropertySource(value = "classpath:application.properties", ignoreResourceNotFound = true)
// 2. Enabling Spring JPA wrapper over introduced package
@EnableJpaRepositories(basePackages = "kh.demo.springboard.repository")
...
public class PersistenceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("kh.demo.springboard");
