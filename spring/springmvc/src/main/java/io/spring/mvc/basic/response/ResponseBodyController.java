package io.spring.mvc.basic.response;

import io.spring.mvc.basic.HelloData;
...
public class ResponseBodyController {
     ...
     * HttpEntity 는 HTTP 메세지의 헤더, 바디 정보를 가지고 있다.
     * ResponseEntity 는 여기에 더해 HTTP 응답 코드를 설정할 수 있다.
     */
    ...
    /**
     * @ResponseBody 를 사용하면 view 를 사용하지 않고, HTTP 메세지 컨버터를 통해서 HTTP 메세지를 직접 입력할 수 있다.
     ...
     * HTTP 메세지 컨버터를 통해서 JSON 형식으로 변화되어서 반환된다.
     */
     ...
     * @ResponseStatus(HttpStatus.??) 애노테이션을 사용하면 응답 코드도 설정할 수 있다.
     *
